...
namespace MyTerraria.UI
{
    class UIItemStack : UIBase
    {
        ...
        public UIItemStack(ItemBase item, int count)
        {
            Item = item;
        ...
        public override void OnDrop(UIBase ui)
        {
            if (ui is UIItemStack)
            {
                ...
                if (itemSrc.Item.IType == itemDest.Item.IType && !itemDest.IsFull && itemDest.ItemCount + itemSrc.ItemCount < itemDest.ItemCountMax)
